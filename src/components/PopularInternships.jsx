...
const PopularInternships = ({ userInternship }) => {
         const paramData = encodeURIComponent(JSON.stringify(userInternship))
    return (
        <div className='max-w-screen-2xl container mx-auto  md:px-12 lg:px-24 px-8 md:py-16 py-16 bg-gray-50 pt-4 pb-5'>
            <div className='flex justify-between md:pr-4'>
                <div>   <p className='text-2xl  medium:hidden font-bold text-blac k mb-1'>
                 Popular Intenships </p>
            <p className='medium:flex text-2xl hidden font-bold text-black  '>
            Popular Intenships on InternLink </p></div>
            <div><Link to={'/internships'}><span className='text-base text-blue cursor-pointer'>View All</span></Link></div>
            </div>
         
            <div className='flex space-x-4  medium:py-6 py-4 overflow-x-auto '>
                        ...
                        <div className='min-w-[313px] medium:min-h-[318px] border bg-white rounded-xl cursor-pointer' key={i}>
                            <div className='p-4 flex flex-col medium:space-y-4 space-y-2  justify-between '>
                                ...
                                <div className='flex  justify-between pt-4'>
                                    <div className='bg-slate-100 px-1.5 py-1 rounded-md text-primary/80 text-[13px]'><span>Internship</span></div>
...
export default PopularInternships